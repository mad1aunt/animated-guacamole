...
#else
#define CC2530_TXPOWER_MIN_20_DBM   0x15
...
#define HAL_RF_TXPOWER_MIN_20_DBM  0
#define HAL_RF_TXPOWER_MIN_3_DBM  1
#define HAL_RF_TXPOWER_0_DBM      2
#define HAL_RF_TXPOWER_4_DBM	  3
...
#else
    case HAL_RF_TXPOWER_MIN_20_DBM: n = CC2530_TXPOWER_MIN_20_DBM; break;
